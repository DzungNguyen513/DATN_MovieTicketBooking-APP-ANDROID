...
import com.example.baseappandroid.ui.home.Helper.Helpers;
import com.example.baseappandroid.utils.Extensions;
...
public class CreateOrder {
    private class CreateOrderData {
        ...
        private CreateOrderData(String amount) throws Exception {
            ...
            AppUser = "Android Movie Booking App";
            ...
            Items = "[]";
            BankCode = "zalopayapp";
            Description = "Đặt vé xem phim #" + Helpers.getAppTransId();
